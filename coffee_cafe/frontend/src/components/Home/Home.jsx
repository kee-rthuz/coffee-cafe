...
import HeroImg from "../../assets/coffee2.webp";
            ...
            <div className="order-2 sm:order-1 flex flex-col justify-center gap-6"> 
                ...
                data-aos="fade-up" data-aos-delay="300">
                    <button className="bg-gradient-to-r
                        from-primary to-secondary border-2 border-primary rounded-full px-4 py-2 text-white hover:scale-105 duration-200">
                        Coffee And Code
                    </button>
                </div>
            </div>
